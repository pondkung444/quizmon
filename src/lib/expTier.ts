// 5 ระดับตาม expEarned ของวันนั้น: 0 / 1-59 / 60-119 / 120-179 / 180 (เต็มเพดาน) — ใช้ใน
// PetCalendarClient (heatmap เต็มเดือนใน /pet/calendar) ห้ามนิยามค่าสี/threshold ซ้ำที่อื่น
//
