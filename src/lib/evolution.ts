...
const SPECIES_NAME_TH: Record<string, EggSpeciesNameSet> = {
  ...
  egg3: {
    baby: "ทิพย์น้อย",
    bySubline: {
      math: { base: "ทิพย์อนันต์", personalityNames: { A: "จอมรังสี", B: "ปราชญ์เรขา" } },
      science: { base: "ทิพย์พฤกษา", personalityNames: { A: "ขุนไพร", B: "เทพพฤกษา" } },
      balanced: { base: "ทิพย์ไอออน", personalityNames: { A: "เพลิงอสูร", B: "เวทอมตะ" } },
    },
  },
  egg4: {
    baby: "ธารน้อย",
    bySubline: {
      math:     { base: "ธารผลึก",    personalityNames: { A: "คมพิฆาต",    B: "โล่อมตะ" } },
      science:  { base: "ธารหิมะ",    personalityNames: { A: "รังสีคำราม", B: "สายชล"   } },
  ...
  egg6: {
    baby: "ธราน้อย",
    bySubline: {
      math:     { base: "ธรามิติ", personalityNames: { A: "ศรทะลวง",   B: "แกนพิทักษ์" } },
      science:  { base: "ธราธาตุ", personalityNames: { A: "ศิลาคลั่ง", B: "มหาคีรี" } },
      balanced: { base: "ธราปฐม",  personalityNames: { A: "พรประทาน",  B: "ฌานสถิต" } },
    },
  },
};
