            ...
            myReward ? (
              ...
              <p className="text-sm text-text3">
                {rewards.length === 0
                  ...
                  : myRank != null && myRank.accuracyPct < 40
                    ? "ไข่รางวัลรอบนี้เทให้คนที่ตอบแม่นเกิน 40% — เล็งให้ชัวร์ก่อนตอบ เดี๋ยวรอบหน้าได้แน่!"
                    : "เกือบแล้ว! ทำดาเมจให้ติดอันดับต้น ๆ รอบหน้ารับไข่เลย"}
              </p>
            )
          ) : rewards.length > 0 ? (
