...
// แนวป้องกันหน้าคริสตัล — จัดทัพ 1-2-2 wedge พุ่งเข้าบอส (บอสอยู่ขวาจอ)
// rank1 หัวขบวน ใกล้บอสสุด/ใหญ่สุด → rank2-3 แถวกลางเหลื่อมบน-ล่าง → rank4-5 แถวหลังเล็กสุด
// bottom % น้อย = ใกล้กล้อง = ดูใหญ่. ค่าล็อกสุดท้าย (ปอนด์จูนบน tuner + /tv จริง 2026-09-02)
const FORMATION = [
  { left: 54, bottom: 14, w: 11.0 }, // 1 — หัวขบวน
  { left: 40, bottom: 20, w: 9.0 }, // 2 — แถวกลาง บน
  { left: 40, bottom: 8, w: 9.0 }, // 3 — แถวกลาง ล่าง
  { left: 26, bottom: 24, w: 7.5 }, // 4 — แถวหลัง บน
  { left: 26, bottom: 6, w: 7.5 }, // 5 — แถวหลัง ล่าง
];
