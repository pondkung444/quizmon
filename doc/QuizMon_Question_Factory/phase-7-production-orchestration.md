...
This is the final Question Factory v1 phase. Automated workers may execute the existing schema-validated Author/QC/Asset adapters until Slots reach Human Review, but Human approval, draft publication and activation remain explicit separate decisions.
